...
const CarouselNew = ({ postsArray }) => {
  ...
  const renderArrow = (dir, ...args) => {
    console.log("RENDER ARROW ARGS:", { dir, args });
...
const Arrow = ({ dir, onClick }) => {
  ...
  const svgClassName = classNames({
    ...
    // "bg-transparent hover:bg-transparent active:bg-transparent": true,
  });
  return (
    <div className={className} onClick={onClick}>
      ...
      {/* <IconButton
        classes={[
          "bg-transparent hover:bg-transparent active:bg-transparent pointer-events-none",
        ]}
        icon={
          <svg
            className={svgClassName}
