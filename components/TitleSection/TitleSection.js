...
const TitleSection = ({ sectionTitle }) => {
  ...
  return (
    <div className={titleWrapperClasses}>
      ...
      <div className="group text-darkgreen absolute top-8 mx-auto hover:-translate-y-3 hover:text-lightgreen duration-300">
        <Link href="/">
